...
- **Desarrollador Junior (Prácticas)** | Presencia Colombo Suiza (6 meses)
  - Desarrollo de soluciones web utilizando **PHP**, **HTML** y **CSS**.
  - Gestión y administración de bases de datos mediante **phpMyAdmin**.
